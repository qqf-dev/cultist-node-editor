 ...
 */
    ...
    _createSVGLayer() {
        ...
        this.viewport.appendChild(svgLayer);
    ...
    _onEvents() {
        ...
        this.bus.on('drag-start:node', this._updateConnections.bind(this));
        // this.bus.on('delete-node', this._updateConnections.bind(this));
    }
    ...
    _onPortDragStart(e) {
        ...
        this.dragState.draggedPort = e.detail.port;

        try {
            this.dragState.draggedPort.dispatchEvent(new CustomEvent('dragging', {            })
            );
